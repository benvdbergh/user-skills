...
class ShapeData:
    ...
    def __init__(
        ...
        self.width: float = round(self.emu_to_inches(shape.width if hasattr(shape, "width") else 0), 2)  # type: ignore
...
def extract_text_inventory(
    ...
    for slide_idx, slide in enumerate(prs.slides):
        shapes_with_positions: List[ShapeWithPosition] = []
