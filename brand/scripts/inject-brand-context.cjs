...
const USAGE = [
  "inject-brand-context.cjs — Extract brand context from markdown guidelines",
  "",
  "Usage:",
  "  bun scripts/inject-brand-context.cjs [path-to-guidelines]",
  "  bun scripts/inject-brand-context.cjs --json [path-to-guidelines]",
  "",
  "Options:",
  "  --json    Output structured JSON instead of prompt text",
  "  --help    Show this help",
  "",
  "Default path: docs/brand-guidelines.md (relative to project cwd)",
].join("\n");
