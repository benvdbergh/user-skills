...
- **Primary color** — color name (e.g., "Ocean Blue") and hex code (e.g., #3B82F6)
- **Secondary color** — color name (e.g., "Golden Amber") and hex code
- **Accent color** — color name (e.g., "Emerald", "Neon Mint") and hex code
- **Brand mood** (for AI image generation) — mood keywords (e.g., "professional, trustworthy, premium" or "bold, creative, energetic")
...
# Check CSS variables (project assets/)
# Review assets/design-tokens.css for --color-primary variables
```
