...
# Resolve assets relative to the skill root (2 levels up from scripts/)
SKILL_ROOT = Path(__file__).resolve().parents[1]
TOKENS_CSS = SKILL_ROOT / "assets" / "design-tokens.css"
TOKENS_JSON = SKILL_ROOT / "assets" / "design-tokens.json"
OUTPUT_DIR = SKILL_ROOT / "assets" / "designs" / "slides"
