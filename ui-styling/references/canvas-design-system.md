...
**Font integration:**
- Search `assets/canvas-fonts` directory (bundled OFL fonts in this skill)
...
### Final Verification
Treat every canvas output as a museum-quality artifact. Pristine execution is the baseline, not the goal — every pixel, spacing value, and color choice must be deliberate and defensible.
