...
| design (logo) | AI logo generation (55 styles, 30 palettes) | `design/SKILL.md` + logo references + `scripts/logo/` |
| design (CIP) | Corporate Identity Program (50 deliverables) | `design/SKILL.md` + CIP references + `scripts/cip/` |
